...
# Create the special class that is going to be used from here on to predict new data.
class absenteeism_model():
    ...
    def load_and_clean_data(self, data_file):
        ...
        # Store the data in a new variable 'df' for later use.
        self.df_with_predictions = df.copy()
        # Drop the 'ID' column.
        df = df.drop(['ID'], axis=1)
        # To preserve the code created in the previous section, will add a column with 'NaN' strings.
        ...
        # Drop the variables that have no explanatory power.
        df = df.drop(['Day of the Week', 'Daily Work Load Average', 'Distance to Work'], axis=1)
            
        # Line of code if want to call the 'preprocessed_data'.
        self.preprocessed_data = df.copy()
            
        # This line is needed to be used in the next functions.
    ...
    # Function which outputs 0 or 1 based on the model.
